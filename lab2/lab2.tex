...
The Aer simulator was used to simulate realistic quantum systems; this provides high-performance quantum computing simulators with realistic noise models locally, and visualization allows you to see what you states look like
