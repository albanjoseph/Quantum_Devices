...
Qubit q$_1$ and qubit q$_2$ were entangled by applying CNOT gate after applying a Hadamard gate. These two qubits were used as the ``third party entangled qubit pair'', shown in Figure \ref{step1}
\begin{figure}[H]
\centering
\begin{tabular}{c}
